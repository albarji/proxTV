...
/* solveTVND_PDR.cpp
   ...
   Solves the general TV proximity problem by applying a Parallel Douglas Rachford splitting algorithm.
...
void mexFunction(int nlhs, mxArray *plhs[ ],int nrhs, const mxArray *prhs[ ]) {
    ...
    PDR_TV(y,lambdas,norms,dims,x,info,ns,nds,npen,ncores,maxIters); 
